...
namespace CCube
{
    ...
    public abstract class BindableBase : INotifyPropertyChanged
    {
        ...
        protected bool SetProperty<T>(ref T storage, T value, string dependentPropertyName, [CallerMemberName] string propertyName = null)
            => SetProperty(ref storage, value, new[] { dependentPropertyName }, propertyName);
